...
IBYTE       last_new_key_kso_index          _at_ 0x62;
IBYTE       last_new_key_ksi_index          _at_ 0x63;
IBYTE       last_new_accept_time            _at_ 0x64;
...
XBYTE       *idata  PeciDataPointer         _at_ 0xBE;
                                        //Reserved 0xBF ~ 0xCF
//****************************************************************************
...
XBYTE   SetShutdownType                     _at_ 0x4E;
...
XBYTE   FnKeyBundledFlag[16]                _at_ 0xE0;

XBYTE   KBCPortPending                      _at_ 0xF0;
XBYTE   PMPortPending                       _at_ 0xF1;

#define eSPI_MemBase            0x00F2
XBYTE   eSPI_CNT_INT153                     _at_ eSPI_MemBase + 0x00;
XBYTE   eSPI_CNT_INT154                     _at_ eSPI_MemBase + 0x01;
XBYTE   eSPI_BUF_VWCTRL1                    _at_ eSPI_MemBase + 0x02;
XBYTE   eSPI_PLTRST_TAG                     _at_ eSPI_MemBase + 0x03;

XBYTE   SMBus5RecoverCunt                   _at_ 0xF8;
XBYTE   SMBus6RecoverCunt                   _at_ 0xF9;
